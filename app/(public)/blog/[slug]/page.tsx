...
export default function BlogPost({ params }: { params: { slug: string } }) {
	const datetime = new Date(mockData.datetime).toLocaleDateString()
	return (
		<section className="flex w-full flex-col items-center">
			<article className="flex max-w-4xl flex-col lg:w-[58%]">
				{/* {params.slug} */}
				<p className="mb-6 text-center text-xs font-light text-neutral-400">
					{mockData.tags.join(", ").toUpperCase()}
				</p>
				...
				<div className="gap-2. flex flex-row-reverse">
					...
					<p className="mb-14 pt-12">{mockData.body}</p>
				</div>
			</article>
